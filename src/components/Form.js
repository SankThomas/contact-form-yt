        ...
        >
          {({ errors, touched }) => (
            <Form className="grid gap-4">
              ...
              <div>
                <label htmlFor="general-enquiry" className="mb-2">
                  Query Type *
                </label>
                <article className="grid gap-4 lg:grid-cols-2">
                  <div className="border-2 border-slate-400 rounded py-2 px-4 text-sm text-teal-800 hover:border-teal-700 focus:border-teal-700 transition">
                    <input
                      type="radio"
              ...
              <button
                type="submit"
                className="bg-teal-800 text-white font-semibold py-2 px-4 rounded hover:bg-teal-900 transition"
              >
                Submit
              </button>
            </Form>
